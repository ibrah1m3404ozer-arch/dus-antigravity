...
import {
    ...
    ChevronDown, ChevronRight, Activity, Sparkles
} from 'lucide-react';
...
function Sidebar() {
    ...
    return (
        <aside className="w-64 h-screen bg-card border-r border-border flex flex-col fixed left-0 top-0 z-50 transition-colors duration-300">
            {/* Logo */}
